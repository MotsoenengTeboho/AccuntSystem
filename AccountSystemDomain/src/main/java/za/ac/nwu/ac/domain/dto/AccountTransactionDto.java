...
public class AccountTransactionDto implements Serializable {
    ...
    private static final long serialVersionID = -673145690115236824L;
    ...
    public AccountTransactionDto(AccountTransaction accountTransaction){
        ...
        this.accountTypeMnemonic = accountTransaction.getMemberType().getMnemonic();
        this.memberId = accountTransaction.getMemberID();
        this.amount = accountTransaction.getTotalAmount();
        this.transactionDate = accountTransaction.getDate();
    }
